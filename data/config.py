...
convexmask_base_config = yolact_base_config.copy({
    ...
    'bce_loss_centerness': False,
    'custom_loss_centerness': True,    
...
convex_synthtree_focal_72 = convex_synthtree_focal.copy({
    'name':'ABLATION_NR_72',
    'num_rays':72,
})

convex_synthtree_focal_box = convex_synthtree_focal.copy({
    'nms_poly':False,
})

convex_synthtree_focal_72_box = convex_synthtree_focal_72.copy({
    'nms_poly':False,
})


convex_synthtree_focal_360 = convex_synthtree_focal.copy({
    'name':'ABLATION_SIZE_360',
    'max_size':(640,360),
})

convex_synthtree_focal_540 = convex_synthtree_focal.copy({
    'name':'ABLATION_SIZE_540',
    'max_size':(960,540),
})
...
convex_synthtree_focal_101_72 = convex_synthtree_focal_101.copy({
    'name':'ABLATION_NR_72_R101',
    'num_rays':72,
})

convex_synthtree_focal_101_box = convex_synthtree_focal_101.copy({
    'nms_poly':False,
})

convex_synthtree_focal_101_72_box = convex_synthtree_focal_101_72.copy({
    'nms_poly':False,
})
